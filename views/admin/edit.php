...
<body style="background-color: aliceblue;">
    ...
    <div class="container-sidebar" style="padding-left: 22vw; padding-right: 25px; padding-block: 50px;">
        ...
        <div class="card shadow-brutal" style="width: 50%;">
            ...
            <form id="form-create" action="<?= Route::to('/admin/post/update') ?>" method="post" enctype="multipart/form-data">
                <input type="hidden" value="<?= $data['post']['id'] ?>" name="id">
                <div class="mb-3">
                    <label for="title" class="form-label">Judul</label>
                    <input required type="text" class="form-control w-100" name="title" value="<?= $data['post']['title'] ?>">
                </div>
                <div class="mb-3">
                    <label for="content" class="form-label">Konten</label>
                    <textarea required name="content" id="content" cols="30" rows="10" class="textarea-control w-100"><?= $data['post']['content'] ?></textarea>
                </div>
                <div class="mb-3">
                    <label for="content" class="form-label">Foto</label>
                    <input name="foto" type="file" class="form-control w-100" style="padding: 8px;">
                </div>
            </form>
        </div>
    </div>
